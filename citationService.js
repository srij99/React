...
export async function getCitationDetails() {
  const data = await httpService.post(`${apiEndpoint}/getCitationDetails`);
  return data;
}

export async function getAddCitation(formData) {
...
export async function getMyCitations(projectId) {
  const data = await httpService.get(
    `${apiEndpoint}/getCitationsByUser/${projectId}`
  );
  return data;
}
